    ...
    <div className="min-h-screen bg-[#080810] overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <TiltCard intensity={10} className="relative">
            <motion.div
              ...
              className="relative z-10 rounded-3xl overflow-hidden shadow-[0_40px_100px_rgba(56,189,248,0.20)] border border-primary/20"
            >
              <img
                ...
                <TiltCard intensity={8}>
                  <Card
                    ...
                    className="group h-full cursor-default
                               ...
                               hover:shadow-[0_8px_40px_rgba(56,189,248,0.15)]"
                  >
                ...
                <TiltCard intensity={6}>
                  <Card
                    ...
                    className="p-0 overflow-hidden group cursor-pointer
                               ...
                               hover:shadow-[0_20px_60px_rgba(56,189,248,0.20)]"
                  >
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <Orb size={600} color="radial-gradient(circle,#38BDF8,transparent 65%)"
          ...
          >
            <Link to="/signup">
              <Button size="lg" className="rounded-full px-10 shadow-2xl shadow-primary/30
                                           bg-primary hover:bg-primary-dark text-neutral-950 font-bold">
                Create Actor Profile
                <Play className="ml-2 h-5 w-5 fill-neutral-950" />
              </Button>
            </Link>
            <Link to="/signup">
              <Button variant="outline" size="lg"
